...
import type { Video, DashboardAnalytics } from "@nichestream/types";
          ...
          <div className="overflow-hidden rounded-xl border border-neutral-800">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-neutral-800 bg-neutral-900">
                {(analytics.recentVideos as Array<{ videoId: string; title: string; views: number; watchTimeMinutes: number }>).map((v) => (
                  <tr key={v.videoId} className="hover:bg-neutral-800/50">
